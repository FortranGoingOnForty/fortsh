...
module readline
  ...
  ! Key codes, sizing constants, mode enums, and the input/history types are
  ! defined in readline_constants (used above). Only mutable module state and
  ! procedures remain here.
