...
check_output "abbr shows multiple" 'abbr a1="echo 1"; abbr a2="echo 2"; abbr -s | wc -l | tr -d " "'
...
check_output "abbr -e then show is gone" 'abbr gs="git status"; abbr -e gs; abbr gs 2>/dev/null; echo $?'

section "4. abbr overwrite and edge cases"
check_exit "abbr overwrite existing" 'abbr gs="git status"; abbr gs="git stash"' "0"
check_output "abbr overwrite changes value" 'abbr gs="git status"; abbr gs="git stash"; abbr gs'
